...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={'textAlign': 'left', 'color': '#000000', 'font-size' :0}),#May include style for title
    html.Div([#TASK 2.2: Add two dropdown menus
        html.Label("Select Statistics:"),
        dcc.Dropdown(
            id='dropdown-statistics',
            options= [{'label': 'Yearly Statistics', 'value':'Yearly Statistics'},
                     {'label': 'Recession Period Statisitcs', 'value': 'Recession Period Statistics'}],
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.bar(average_sales, x='Vehicle_Type', y='Automobile_Sales',title='Average number of vehicles soly by vehicle type'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        exp_data=yearly_data.groupby('Vehicle_Type')['Automobile_Expenditure'].sum().reset_index()
